package muhammadfauzi.polbeng.ac.id.kabupatenkotariauapp_p8
...
import muhammadfauzi.polbeng.ac.id.kabupatenkotariauapp_p8.databinding.ItemCardKabkotaBinding
...
class CardKabKotaAdapter(private val listKabKota: ArrayList<KabKota>) :
    ...
    class CardViewHolder(val binding: ItemCardKabkotaBinding) : RecyclerView.ViewHolder(binding.root)
